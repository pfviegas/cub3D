...
/*   Updated: 2024/02/20 11:38:35 by pveiga-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_colors(t_cub3d *cub3d, char *cl, int i, int flag)
{
	...
	free(temp);
	if (j != 3)
		quit("Error:\n Invalid color format (RGB).", cub3d, 31);
	if (flag == 5)
...
/**
 * Verifica se há espaços em branco em uma string a partir 
